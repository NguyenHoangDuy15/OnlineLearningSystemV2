            ...
            <div class="container py-5">
                ...
                <div class="row">
                    <c:choose>
                                ...
                                <div class="col-lg-12 mb-4"> <!-- Sử dụng col-lg-12 để mỗi hàng chỉ có 1 khóa học -->
                                    <div class="card border-0 shadow d-flex flex-row align-items-center p-3">
                                        ...
                                        <div style="flex: 0 0 30%;">
                                            <img class="img-fluid rounded" src="${e.image}" alt="${e.name}" style="width: 100%; height: 250px; object-fit: cover;">
                                        </div>
                                        <!-- Nội dung bên phải -->
                                        <div class="card-body ml-4" style="flex: 1;">
                                            ...
                                            <a  class="btn btn-primary text-white" style="background-color: #007bff; border-color: #007bff;">View certificate</a>
                        ...
                        <c:otherwise>
                            <p class="text-center">You do not have in course. </p>
                        </c:otherwise>
                    </c:choose>
                </div>
            </div>
