 ...
 * @author DELL
 */
public class ListTranscriptByAdminServlet extends HttpServlet {
     ...
     */
    public int getNoPage(List<MoneyHistoryByAdmin> list) {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            int index = 1;
            int NoPage = getNoPage(adao.getAllHistory());
            ...
            request.getRequestDispatcher("jsp/ListOfMoneyHistoryByAdmin.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
