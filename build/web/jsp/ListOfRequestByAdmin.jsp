...
<html>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="display table table-striped table-hover" >
                                            ...
                                            <tbody>
                                                <c:forEach items="${sessionScope.listRequest}" var="s">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <c:if test="${s.getRequestedRole() == 2}">
                                                                <span style="color: red; font-weight:bold">Expert</span>
                                                            </c:if>
                                                            <c:if test="${s.getRequestedRole() == 3}">
                                                                <span style="color: green; font-weight:bold">Seller</span>
                                                            </c:if>
                                                        </td>

                                                        <td>
                                                            <div class="form-button-action">
                                                                <a href="UpdateRoleUserServlet?requestID=${s.getRequestID()}&userID=${s.getUserID()}&requestRole=${s.getRequestedRole()}" >
                                                                    <button
                                                                        type="button"
                                                                ...
                                                                <button
                                                                    ...
                                                                    onclick="doDelete(${s.getRequestID()})"
                                                                    >
                                    ...
                                    <div class="demo">
                                        <ul class="pagination pg-primary" style="display: flex; justify-content: flex-end;">
                                            ...
                                            <li class="page-item ${index < 2 ? 'disabled' :'' } ">
                                                <a class="page-link" href="listRequest?index=${index-1}" aria-label="Previous">
                                            ...
                                            <c:forEach var="p" begin="${startPage}" end="${endPage}">
                                                <c:if test="${index == p}">
                                                    <li class="page-item active">
                                                        <a class="page-link" href="listRequest?index=${p}">${p}</a>
                                                    </li>
                                                </c:if>
                                                <c:if test="${index != p}">
                                                    <li class="page-item">
                                            ...
                                            <li class="page-item ${index < Nopage ? '' :'disabled' }" >
                                                <a class="page-link" href="listRequest?index=${index+1}" aria-label="Next">
    ...
    <script>
        function doDelete(requestID) {
            var option = confirm("Are you sure to Reject this Request?");
            if (option === true) {
                window.location = "DeleteRequestServlet?requestID=" + requestID;
            }
        }
    </script>
    <script>
